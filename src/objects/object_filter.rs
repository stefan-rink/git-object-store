 ...
 */
pub fn object_filter(service: ObjectService) -> impl Filter<Extract = impl warp::Reply, Error = warp::Rejection> + Clone {
...
fn with_service(service: ObjectService) -> impl Filter<Extract = (ObjectService,), Error = std::convert::Infallible> + Clone {
